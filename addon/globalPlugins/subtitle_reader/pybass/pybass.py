...
BASS_SampleGetInfo = func_type(ctypes.c_bool, HSAMPLE, ctypes.POINTER(BASS_SAMPLE))(
	("BASS_SampleGetInfo", bass_module),
)
# BOOL BASSDEF(BASS_SampleSetInfo)(HSAMPLE handle, const BASS_SAMPLE *info);
BASS_SampleSetInfo = func_type(ctypes.c_bool, HSAMPLE, ctypes.POINTER(BASS_SAMPLE))(
...
BASS_ChannelSetDevice = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_ChannelGetTags = func_type(ctypes.c_void_p, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_ChannelIsSliding = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_ChannelSetFX = func_type(HFX, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_int)(
